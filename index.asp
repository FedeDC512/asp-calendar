...
<body>
    <div class="login-container">
        <div class="vertical-login">
            ...
            Welcome to Ruby Rhino Rentals, <br>your premier destination for hassle-free car rentals.</div>
            <div class="login-box">
                <div class="login-title stick-regular">Please login</div>
        ...
        <img class="family" src="cars/family-vaca.png" alt="Family Vacation">
    </div>
</body>
</html>
