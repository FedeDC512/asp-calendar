...
<head>
    ...
    $(document).ready(function() {
        ...
        function loadCars() {
            ...
            loading = true;
                $.ajax({
                    ...
                    type: "GET",
                    dataType: "json",
                    data: { numCarsToLoad: 6,
                            currentCarPage: currentCarPage },
        ...
        // Funzione per caricare ulteriori dati delle macchine quando si scorre verso il basso
        $(window).scroll(function() {
            // Se si è raggiunta la fine della pagina
